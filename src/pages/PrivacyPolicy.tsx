      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto flex max-w-3xl flex-col gap-8">
          <header className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">Last updated: January 08, 2026</p>
          </header>
            ...
            <div className="space-y-3 text-sm leading-relaxed text-muted-foreground">
              ...
              <ul className="list-disc space-y-2 pl-6">
                ...
                <li>
                  ...
                  this Agreement) refers to FollowUp.
                </li>
                <li>
                ...
                <li>
                  ...
                  of the Company, to perform services related to the Service or to assist the Company in
                ...
                <li>
                  <strong>Website</strong> refers to FollowUp, accessible from{" "}
                  <a
                    className="underline underline-offset-4 transition hover:text-foreground"
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
              ...
              <h4 className="text-sm font-semibold text-foreground">Personal Data</h4>
              <p>
              ...
              <h4 className="text-sm font-semibold text-foreground">Usage Data</h4>
              <p>Usage Data is collected automatically when using the Service.</p>
              <p>
                Usage Data may include information such as Your Device's Internet Protocol address (for
                example, IP address), browser type, browser version, the pages of our Service that You
              ...
              <h4 className="text-sm font-semibold text-foreground">Tracking Technologies and Cookies</h4>
              <p>
              ...
              <h3 className="text-base font-semibold text-foreground">Use of Your Personal Data</h3>
              ...
              <ul className="list-disc space-y-2 pl-6">
                ...
                <li>
                  ...
                  you have already purchased or inquired about unless You have opted not to receive
                  such information.
                </li>
                <li>
              ...
              <h3 className="text-base font-semibold text-foreground">Retention of Your Personal Data</h3>
              <p>
              ...
              <h3 className="text-base font-semibold text-foreground">Transfer of Your Personal Data</h3>
              <p>
              ...
              <h3 className="text-base font-semibold text-foreground">Delete Your Personal Data</h3>
              <p>
              ...
              <h3 className="text-base font-semibold text-foreground">Disclosure of Your Personal Data</h3>
              <h4 className="text-sm font-semibold text-foreground">Business Transactions</h4>
              <p>
              ...
              <h4 className="text-sm font-semibold text-foreground">Law enforcement</h4>
              <p>
                Under certain circumstances, the Company may be required to disclose Your Personal Data
                if required to do so by law or in response to valid requests by public authorities (for
                example, a court or a government agency).
              </p>
              <h4 className="text-sm font-semibold text-foreground">Other legal requirements</h4>
              <p>
              ...
              <h3 className="text-base font-semibold text-foreground">Security of Your Personal Data</h3>
              <p>
                The security of Your Personal Data is important to Us, but remember that no method of
                transmission over the Internet, or method of electronic storage is 100% secure. While
                We strive to use commercially reasonable means to protect Your Personal Data, We cannot
